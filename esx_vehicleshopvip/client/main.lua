...
local priceDisplay = Config.UseVIPCredits and TranslateCap('generic_shopitem', ESX.Math.GroupDigits(vehicle.price)) or TranslateCap('generic_shopitem', ESX.Math.GroupDigits(vehicle.price))
...
title = Config.UseVIPCredits and TranslateCap('buy_vehicle_shop', vehicleData.name, ESX.Math.GroupDigits(vehicleData.price)) or TranslateCap('buy_vehicle_shop', vehicleData.name, ESX.Math.GroupDigits(vehicleData.price)),
            align = 'top-left',
            elements = {
...
local notification = Config.UseVIPCredits and TranslateCap('not_enough_money') or TranslateCap('not_enough_money')
